...
#let relu-star-diagram = canvas(length: 1cm, {
  ...
  line((-0.8, 0), (3.2, 0), stroke: (paint: col-ax, thickness: 0.8pt), mark: (end: ">", size: 0.18))
  line((0, -0.5), (0, 2.0), stroke: (paint: col-ax, thickness: 0.8pt), mark: (end: ">", size: 0.18))
  ...
  line((1.5, 0), (1.5, 1.5), stroke: (paint: luma(200), thickness: 0.6pt, dash: "dashed"))
  line((0, 1.5), (1.5, 1.5), stroke: (paint: luma(200), thickness: 0.6pt, dash: "dashed"))
...
#let gnn-diagram = canvas(length: 1cm, {
  ...
  let edge-style = (stroke: (paint: col-edge, thickness: 1.2pt), mark: (end: ">", size: 0.25))
  ...
  circle(v, radius: node-r * 1.3, fill: col-center, stroke: (paint: white, thickness: 1.5pt))
  content(v, text(fill: white, size: 0.34cm, weight: "bold")[$v$])
  content((0, -1.25), text(fill: col-edge, size: 0.28cm, style: "italic")[
...
#let rgnn-rounds-diagram = canvas(length: 1cm, {
  ...
  line((0.6, 0.3), (1.5, 0.3), stroke: (paint: luma(180), thickness: 0.7pt), mark: (end: ">", size: 0.16))
  ...
  line((2.7, 0.3), (3.2, 0.3), stroke: (paint: luma(180), thickness: 0.7pt), mark: (end: ">", size: 0.16))
  content((3.65, 0.3), text(size: 0.38cm, fill: luma(160))[...])
  line((4.1, 0.3), (4.6, 0.3), stroke: (paint: luma(180), thickness: 0.7pt), mark: (end: ">", size: 0.16))

  circle((4.9, 0.6), radius: 0.33, fill: col-a, stroke: (paint: white, thickness: 1.5pt))
  ...
  line((4.9, 1.15), (4.9, 0.94), stroke: (paint: col-a, thickness: 0.7pt), mark: (end: ">", size: 0.13))
...
#let reachability-example = canvas(length: 1.1cm, {
  ...
  content(w1, text(fill: black, size: 0.45cm, weight: "bold")[☕])
  circle(w2, radius: 0.34, fill: white, stroke: black)
  content(w2, text(fill: black, size: 0.45cm, weight: "bold")[🍌])
  ...
  content(w5, text(fill: black, size: 0.45cm, weight: "bold")[🍎])
  circle(w6, radius: 0.34, fill: white, stroke: black)
  content(w6, text(fill: black, size: 0.45cm, weight: "bold")[☕])
  ...
  circle(v, radius: 1.1, fill: none, stroke: (paint: rgb(210, 200, 255), thickness: 2.8pt, dash: "dashed"))
})
...
#let rgnn-big-diagram = canvas(length: 1.1cm, {
  ...
  line(
    (vx3, ny + 1.33),
    (vx3, ny + rv * 1.28 + 0.06),
    stroke: (paint: col-1, thickness: 0.8pt),
    mark: (end: ">", size: 0.15),
  )
})
